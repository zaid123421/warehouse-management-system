...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-md py-2 ps-3 pe-8 text-body-md outline-none focus:bg-primary-dark/10 focus:text-primary-dark data-[state=checked]:text-primary-dark data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className
    )}
    {...props}
  >
