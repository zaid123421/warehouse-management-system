...
export function OutboundSchedulingBoard() {
  ...
  const gridCells = useMemo(
    () => toSchedulingGridCells(data?.cells ?? [], (cell) => cell.deliveryDay),
    [data?.cells],
  );
      ...
      toolbar={
        <>
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
            ...
            >
              {generateMutation.isPending ? t("generating") : t("generatePickingByDay")}
            </Button>
            <Button
              type="button"
              variant="outline"
      ...
      grid={
        <>
          ...
          <SchedulingWeekGrid
            ...
            canApprove={canApproveOutboundSchedulingCell}
