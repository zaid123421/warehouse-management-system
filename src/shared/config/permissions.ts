...
const ROLE_ROUTE_PREFIXES: Record<Role, string[]> = {
  admin: [
    ...
    ROUTES.DASHBOARD.INBOUND_SESSIONS,
    '/dashboard/inbound-sessions/',
    ROUTES.DASHBOARD.OUTBOUND_SESSIONS,
...
export const NAV_ENTRIES = [
  ...
  { path: ROUTES.DASHBOARD.INBOUND_SESSIONS, label: 'Inbound Sessions', key: 'inboundSessions' },
  { path: ROUTES.DASHBOARD.OUTBOUND_SESSIONS, label: 'Outbound Sessions', key: 'outboundSessions' },
